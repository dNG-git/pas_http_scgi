...
with TemporaryDirectory(dir = ".") as build_directory:
    parameters = { "install_data_plain_copy_extensions": "sql",
                   "pasHttpScgiVersion": get_version()
                   }
    ...
    setup(name = "pas_http_scgi",
          version = get_version(),
          description = "Python Application Services",
          long_description = """"pas_http_scgi" provides a SCGI compliant server implementation.""",
          author = "direct Netware Group et al.",
          author_email = "web@direct-netware.de",
          license = "GPLv2+",
          url = "https://www.direct-netware.de/redirect?pas;http;scgi",
